...
export function MultiSelect({
  ...
  const borderColor = "gray"; // Define the borderColor variable
    ...
    <div className="w-full">
      ...
      <div className="dropdown w-full">
        <div
          tabIndex={0}
          role="button"
          className={`multiselect-btn btn h-max p-2 px-3 w-full justify-start font-normal bg-base-100 border-[${borderColor}] shadow-none`}
        >
          {!hasSelection() ? (
